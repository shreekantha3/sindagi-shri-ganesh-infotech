# Shri Ganesh Infotech — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-shri-ganesh-infotech/
- **Repo:** `shreekantha3/sindagi-shri-ganesh-infotech` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-shri-ganesh-infotech/'` for GitHub Pages project-site hosting.
